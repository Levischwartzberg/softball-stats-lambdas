        ...
        atBatDTOS.forEach(atBatDTO -> {
            try (Connection connection = DriverManager.getConnection(this.dbUrl, this.dbUser, this.dbPassword)) {
                String atBatValues = String.format("(%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
                        ...
                        atBatDTO.getResult().equals(ResultENUM.WALK) || atBatDTO.getResult().equals(ResultENUM.SKIP) ? 0 : 1,
                        (atBatDTO.getResult().equals(ResultENUM.WALK) || atBatDTO.getResult().equals(ResultENUM.OUT) || atBatDTO.getResult().equals(ResultENUM.ERROR) || atBatDTO.getResult().equals(ResultENUM.SKIP)) ? 0 : 1,
